...
public class Orders {
    ...
    public Orders(String order_id,int qty){
    ...
    public Orders(String order_id, String reception_id, String date, String time, String cus_name, String tp_no, int qty, String status) {
        this.order_id = order_id;
